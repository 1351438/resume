...
import BlueprintCanvas from "@/canvas.tsx";
import ArrowBackgroundCanvas from "@/arrow-canvas.tsx";
...
export default function Home() {
    ...
    useGSAP(
        () => {
            const blurbs = [
                "Frontend Developer (React) with experience in UI/UX, TypeScript, and PHP integration",
                "React Frontend Developer with experience connecting interfaces to PHP-based systems",
                "Web Developer focused on React UI development, with familiarity in PHP backend workflows",
                "Frontend Engineer working mainly in React, with hands-on PHP and TypeScript exposure",
            ];
            let curIndex = 0;
        ...
        >
            ...
            <div className="flex flex-col justify-center items-center absolute inset-0 "
                ...
                <div className="flex gap-4 flex-wrap w-full justify-center items-center">
                    <Button onClick={() => scrollToPanel(2)}>
                        Technical Proficiencies
                    </Button>
                    <Button onClick={() => scrollToPanel(5)}>Get in touch</Button>
            ...
            >
                <defs>
                    <linearGradient id="gradient1" x1="0%" y1="0%" x2="0%" y2="100%">
                        <stop offset="0%" stopColor="#0A8DFF"/>
                        <stop offset="100%" stopColor="#59B2FF"/>
                    </linearGradient>
                    <linearGradient id="gradient2" x1="0%" y1="0%" x2="0%" y2="100%">
                        <stop offset="0%" stopColor="#5181CA"/>
                        <stop offset="100%" stopColor="#0A295E"/>
                    </linearGradient>
                </defs>
    ...
    const ProgrammingLanguageCard = ({
        ...
        <Card
            className="cursor-pointer h-[85px] lg:h-[200px] w-full md:w-[300px] animate-fade-in transition-all duration-500 hover:scale-105 hover:shadow-lg relative overflow-hidden pt-[32px]">
    ...
    return (
        <div>
            <div ref={containerRef} className="relative overflow-x-hidden">
                <IntroPanel index={0}/>
                <section
                    className="p-4 panel h-screen bg-gradient-to-b from-[#000000] via-[#101010] to-[#10101A] flex items-center justify-center text-white text-3xl font-bold">

                    <div className={"max-w-[600px] gap-4 flex flex-col"}>
                        <p className={"text-md font-bold"}>About Me</p>
                        <div className={"w-[64px] h-[2px] bg-white "}>{" "}</div>
                        <p className={"text-sm font-normal"}>I am a 23-year-old Computer Engineering student with over 5
                            years of professional experience
                            in web
                            development. Beyond just writing code, I am driven by a deep passion for analytical
                            problem-solving and a
                            commitment to creating helpful products that improve people's lives. I thrive in
                            collaborative environments
                            where innovation is the priority and am always looking for new ways to build scalable,
                            user-focused
                            solutions.
                        </p>
                        <p className={"text-sm font-normal"}>

                            Having collaborated with many talented engineers, I have developed a deep appreciation for
                            the diverse
                            perspectives and problem-solving styles within a team. I prioritize understanding different
                            personality types to
                            bridge gaps in communication, utilizing my Farsi (Native language) and English
                            (Intermediate) to foster
                            meaningful dialogue. My goal is always to create a productive, harmonious teamwork
                            experience that turns
                            technical challenges into successful, collective outcomes.
                        </p>
                    </div>
                </section>
                <motion.section
        ...
        bg-gradient-to-b from-[#10101A] via-[#10101A] to-[#10101A]
        flex items-center justify-center text-white text-3xl font-bold"
                >
                    ...
                    <div className="flex flex-col lg:flex-row gap-5 md:gap-3 justify-center items-center">
                        <div
                            className="flex flex-col gap-4 items-center justify-center max-w-[450px] font-normal text-center">
                ...
                <section
                    className="flex flex-col gap-8 md:gap-32 panel h-screen bg-gradient-to-b from-[#ECE5F0] via-[#F5F3F7] to-white flex items-center justify-center text-black text-3xl font-bold">
                ...
                <section
                    className="panel h-screen bg-gradient-to-b from-white via-[#ECE5F0] to-[#101524] flex items-center justify-center  text-3xl font-bold">
                    <p
                ...
                <section
                    className="panel h-screen bg-gradient-to-t from-[#000000] to-[#003B36] flex items-center justify-center text-white  font-bold">
                    <ArrowBackgroundCanvas/>
                        ...
                        <div className="flex flex-col gap-4 max-w-[600px] items-center justify-center">
                            ...
                            <div className="w-full flex flex-col gap-4">
                                <InputGroup className="max-w-[300px]">
                                    <InputGroupInput
                                        placeholder="Email"
                                        value={"contact@mortezabagheri.ir"}
                                        readOnly
                                    />
                                    <InputGroupAddon>
                                        <MailIcon/>
